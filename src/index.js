...
Aspectos a incluir
  ...
  *No es necesario desarrollar vistas para módulos que no influyan en el proceso de compra
  (Como vistas de usuarios premium para crear productos, o vistas de panel de admin para updates de productos, etc)
  *Realizar el despliegue de tu aplicativo en la plataforma de tu elección
  (Preferentemente Railway.app, pues es la abarcada en el curso) y corroborar que se puede llevar a cabo un proceso de compra completo.
...
import { everyTimeDisableUsers } from './cronJobs.js';
...
void(async() =>
{
  try
  {
    ...
    app.build();
    app.listen();
    const disableUsers = everyTimeDisableUsers;
  }
  catch (err)
  {
